    ...
    <div className="container mx-auto px-4">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-primary-foreground">Movix</span>
        </Link>
        ...
        <p className="text-xs text-primary-foreground/30">© 2026 Movix. Todos los derechos reservados.</p>
      </div>
    </div>
  </footer>
);
